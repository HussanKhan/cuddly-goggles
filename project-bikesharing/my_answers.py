...
class NeuralNetwork(object):
    def __init__(self, input_nodes, hidden_nodes, output_nodes, learning_rate):
        ...
        self.activation_function_derv = lambda x : sigmoid_derivative
    ...
    def forward_pass_train(self, X):
        ...
        hidden_outputs = hidden_inputs.dot(self.weights_input_to_hidden) # signals from hidden layer

        # TODO: Output layer - Replace these values with your calculations.
        final_inputs = hidden_outputs # signals into final output layer
        final_outputs = self.activation_function(final_inputs.dot(self.weights_hidden_to_output)) # signals from final output layer
    ...
    def backpropagation(self, final_outputs, hidden_outputs, X, y, delta_weights_i_h, delta_weights_h_o):
        ...
        hidden_error = error * self.activation_function_derv(final_outputs)
        ...
        delta_weights_i_h += X.T.dot(hidden_error)
        # Weight step (hidden to output)
        delta_weights_h_o += hidden_outputs.T.dot(hidden_error_term)
